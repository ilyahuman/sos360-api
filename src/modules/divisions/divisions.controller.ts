...
import { CreateDivisionRequest, UpdateDivisionRequest, EntityReassignmentRequest, BulkReassignmentRequest } from './divisions.types';

export class DivisionController {
  constructor(private divisionService: DivisionService) {}

  createDivision = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
