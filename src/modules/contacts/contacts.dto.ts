...
export interface CreateContactDTO {
  ...
  // Division Assignment (optional in DTO - will default to "General" division if not provided)
  divisionId?: string;
...
export interface UpdateContactDTO {
  ...
  // Division Assignment (must be valid division ID if provided)
  divisionId?: string;
...
export interface ContactResponseDTO {
  id: string;
  companyId: string;
  divisionId: string; // Always present - contacts must belong to a division
...
export class ContactDTOMapper {
  ...
  static toCreateInput(
    ...
    return {
      ...
      // Division relationship (required - validated by service layer)
  ...
  static toUpdateInput(dto: UpdateContactDTO, userId: string): Prisma.ContactUncheckedUpdateInput {
    ...
    // Division Assignment (required - cannot be null)
    if (dto.divisionId !== undefined) {
      if (!dto.divisionId) {
        throw new Error('divisionId cannot be null or empty - contacts must belong to a division');
      }
